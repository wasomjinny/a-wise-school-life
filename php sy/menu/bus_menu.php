...
<div class="left_frame_menu">
	<select name="menu" size="1" id="menu" class="selectinput" onchange="ChangeSelect(this);">
		...
		<option value="/school/menu/bus_menu.php-/school/bus/busroutine_list.php" selected>버스시간표</option>
		<option value="/school/menu/code_menu.php-/school/code/code_list.php">코드관리</option>
	</select>
</div>
</form>
<br />
<div onclick="go('/school/bus/busroutine_list.php')" class="left_menu_out" onmouseover="style_toggle(this,'left_menu_over')" onmouseout="style_toggle(this,'left_menu_out')">버스노선 목록</div> <!-- 등록하기 -->
<div onclick="go('/school/bus/bulletin_list.php')" class="left_menu_out" onmouseover="style_toggle(this,'left_menu_over')" onmouseout="style_toggle(this,'left_menu_out')">공지사항 목록</div> <!-- 등록하기 -->
</body>
</html>
