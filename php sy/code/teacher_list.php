...
function do_edit(todo,code_no) {
	win_open("teacher_edit.php?todo="+todo+"&code_no="+code_no,"materialedit",600,480);
}
...
<table border="0" cellpadding="0" cellspacing="0" width="90%">
	<tr>
		<td><span class="header">선생님 목록</span></td> <!-- 결과 -->
		<td>
...
$sql_select = "	select a.*, b.name as gwamok_name ";

$sql_from = " from teacher a
							left outer join code b on b.no = a.gwamok ";
...
<tr>
	...
	<th>과목 <a href="javascript:do_sort('a.gwamok')">▲</a></th>
	<th>전화번호</th>
	<th>로그인ID</th>
	<th>패스워드</th>
</tr>
...
if($result) {
	while($r=mysqli_fetch_array($result)) {
		...
		<tr bgcolor="#ffffff" onmouseover="tr_over(this)" onmouseout="tr_out(this)" onclick="$(this).toggleClass('select_row');">
			...
			<td align="center"><?=$gwamok_name?></td>
